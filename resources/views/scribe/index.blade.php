                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-posts">POST api/posts</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-posts--post_id-">
                                <a href="#endpoints-PUTapi-posts--post_id-">PUT api/posts/{post_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-posts--post_id-">
                                <a href="#endpoints-DELETEapi-posts--post_id-">DELETE api/posts/{post_id}</a>
                            </li>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 3 characters. Example: <code>-0pBNvYgxw</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "image=@/private/var/folders/bf/g1z33ql11s9f55z48plmvr7m0000gn/T/phpcvfe4dbth1iidPd14TT" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/private/var/folders/bf/g1z33ql11s9f55z48plmvr7m0000gn/T/phpcvfe4dbth1iidPd14TT</code></p>
        </div>
        </form>

                    <h2 id="endpoints-PUTapi-posts--post_id-">PUT api/posts/{post_id}</h2>
...
<div class="bash-example">
    ...
    --form "title=b"\
    --form "content=architecto"\
    --form "image=@/private/var/folders/bf/g1z33ql11s9f55z48plmvr7m0000gn/T/php7bck6tgjr8fkd80mQMj" </code></pre></div>
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="PUTapi-posts--post_id-"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/private/var/folders/bf/g1z33ql11s9f55z48plmvr7m0000gn/T/php7bck6tgjr8fkd80mQMj</code></p>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-posts--post_id-">DELETE api/posts/{post_id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/posts/16/comments" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"comment\": \"architecto\"
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="comment"                data-endpoint="POSTapi-posts--post_id--comments"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
